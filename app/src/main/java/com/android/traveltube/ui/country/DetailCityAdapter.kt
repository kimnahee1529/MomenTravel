...
class DetailCityAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            TYPE_NORMAL -> {
                val binding = ItemDetailCityBinding.inflate(
            ...
            TYPE_IMG -> {
                val binding1 = ItemInterestPlusBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false
                )
    ...
    inner class InterestViewHolder(val binding1: ItemInterestPlusBinding) :
    ...
    inner class ViewHolder(val binding: ItemDetailCityBinding) :
